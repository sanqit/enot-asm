...
const parseRegister = (input: string) => {
...
const parseOffsetAddressing = (input: string) => {
...
const parseRegOrNumber = (
  input: string,
  typeReg: "regaddress" | "register",
  typeNumber: "address" | "number"
) => {
...
const checkNoExtraArg = (instr: string, arg: any) => {
  if (arg !== undefined) {
  ...
  static go(input: string) {
    ...
    for (var i = 0, l = lines.length; i < l; i++) {
      try {
          ...
          if (match[2] !== undefined) {
            ...
            switch (instr) {
              case "DB":
                ...
                else throw new Error("DB does not support this operand");
              ...
              case "MOV":
                ...
                else throw new Error("MOV does not support this operands");
              ...
              case "ADD":
                ...
                else throw new Error("ADD does not support this operands");
              ...
              case "SUB":
                ...
                else throw new Error("SUB does not support this operands");
              ...
              case "INC":
                ...
                else throw new Error("INC does not support this operand");
              ...
              case "DEC":
                ...
                else throw new Error("DEC does not support this operand");
              ...
              case "CMP":
                ...
                else throw new Error("CMP does not support this operands");
              ...
              case "JMP":
                ...
                else throw new Error("JMP does not support this operands");
              ...
              case "JNAE":
                ...
                else throw new Error(`${instr} does not support this operand`);
              ...
              case "PUSH":
                ...
                else throw new Error("PUSH does not support this operand");
              ...
              case "CALL":
                ...
                else throw new Error("CALL does not support this operand");
              ...
              case "MUL":
                ...
                else throw new Error("MULL does not support this operand");
              ...
              case "DIV":
                ...
                else throw new Error("DIV does not support this operand");
              ...
              case "AND":
                ...
                else throw new Error("AND does not support this operands");
              ...
              case "OR":
                ...
                else throw new Error("OR does not support this operands");
              ...
              case "XOR":
                ...
                else throw new Error("XOR does not support this operands");
              ...
              case "NOT":
                ...
                else throw new Error("NOT does not support this operand");
              ...
              case "SAL":
                ...
                else throw new Error(`${instr} does not support this operands`);
        ...
        debugger;
        throw { error: e.message, line: i + 1 };
      }
    }
